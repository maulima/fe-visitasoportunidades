...
class FormularioVisita {
    static reduce(state = initialState, action) {
        if (FormularioVisita[action.type]) {
            return FormularioVisita[action.type](state, action);
        } else {
            return state
        }
    }

    static [Action.GET_FORMULARIO_INICIAL_VISITA_REQUEST](state, action) {
        return {
            ...state,
            isFetching: true,
            initialFormLoaded: false,
    ...
    static [Action.GET_FORMULARIO_INICIAL_VISITA_SUCCESS](state, action) {
    ...
    static [Action.GET_FORMULARIO_INICIAL_VISITA_ERROR](state, action) {
        const { error } = action
    ...
    static [Action.GET_PREGUNTAS_FORMULARIO_VISITA_REQUEST](state, action) {
        return {
            ...state,
            isFetching: true,
            hasError: false
    ...
    static [Action.GET_PREGUNTAS_FORMULARIO_VISITA_SUCCESS](state, action) {
    ...
    static [Action.GET_PREGUNTAS_FORMULARIO_VISITA_ERROR](state, action) {
    ...
    static [Action.CLEAR_FORMULARIO_VISITA_SUCCESS](state, action) {
        return {
            ...initialState
        }
    }

    static [Action.REPLACE_FORMULARIO_VISITA_ATTRIBUTES](state, action) {
...
export default FormularioVisita.reduce
